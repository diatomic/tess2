...
void tess_kdtree_exchange(diy::Master& master, const diy::Assigner& assigner, bool wrap, bool sampling = false);
void tess_kdtree_exchange(diy::Master& master, const diy::Assigner& assigner, double* times, bool wrap, bool sampling = false);
